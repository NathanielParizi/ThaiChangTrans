...
public class SettingsActivity extends AppCompatActivity {
   ...
   private FirebaseUser mCurrentUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String phone_value = getIntent().getStringExtra("phone_value");
        ...
        mStatusUpdateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                statusIntent.putExtra("phone_value", phone_value);
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")){
                    Picasso.get().load(image).placeholder(R.drawable.defaultprofilepicture).into(mDisplayImage);
                }
